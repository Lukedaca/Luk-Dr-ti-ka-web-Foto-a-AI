...
export class InMemoryLeadDispatcher {
    constructor() {
        this.id = 'in-memory-lead-dispatcher';
        this.dispatched = [];
    }
    async dispatch(lead) {
...
export class LeadStream {
     ...
     */
    static toSafeLearningEvent(lead) {
        return {
            kind: 'conversion',
            payload: {
                domain: lead.domain,
     ...
     */
    async processInput(text, contextHint) {
...
//# sourceMappingURL=LeadStream.js.map