export function createSportsClubProfile(overrides) {
    return {
        id: (overrides === null || overrides === void 0 ? void 0 : overrides.id) || 'sports-club-agent',
        name: (overrides === null || overrides === void 0 ? void 0 : overrides.name) || 'Klubová sportovní agentka',
        domain: 'sports-club',
        ...
        disclosure: (overrides === null || overrides === void 0 ? void 0 : overrides.disclosure) || 'Jsem klubová AI agentka. Pomohu vám najít ověřené informace o zápasech, trénincích, náborech a týmech.',
        privacyNotice: (overrides === null || overrides === void 0 ? void 0 : overrides.privacyNotice) || 'V soukromém režimu se vaše dotazy zpracovávají přímo v prohlížeči.',
...
//# sourceMappingURL=sportsClubProfile.js.map