...
;(function i18nIIFE() {
  ...
  var currentLanguage = 'cs';
    ...
    en: {
      ...
      nav: ['AI Assistant', 'Portfolio', 'Skills', 'About', 'Collaboration', 'Contact'],
      hero: ['Photography', 'AI Development', 'Automation', 'Photographer & AI Developer', 'View portfolio', 'AI Assistant'],
      ai: ['Lukas AI', 'Ask about photography, AI projects or collaboration. You can write in Czech or English and also start the assistant by voice.', 'Write to me or click Talk by voice', 'Ask in English or switch to Czech...', 'Talk by voice', 'Send'],
